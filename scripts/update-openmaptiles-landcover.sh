...
wget --no-check-certificate -nv -O ./local/ne_10m_antarctic_ice_shelves_polys.zip https://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/physical/ne_10m_antarctic_ice_shelves_polys.zip
wget --no-check-certificate -nv -O ./local/ne_10m_glaciated_areas.zip https://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/physical/ne_10m_glaciated_areas.zip
wget --no-check-certificate -nv -O ./local/ne_10m_urban_areas.zip https://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_urban_areas.zip
...
cat local/ne_10m_antarctic_ice_shelves_polys.ndjson | node node_modules/.bin/ndjson-map 'd.properties.class="ice",d.properties.subclass="glacier",d' > local/ne_10m_antarctic_ice_shelves_polys.geojson
cat local/ne_10m_glaciated_areas.ndjson | node node_modules/.bin/ndjson-map 'd.properties.class="ice",d.properties.subclass="glacier",d' > local/ne_10m_glaciated_areas.geojson
cat local/ne_10m_urban_areas.ndjson | node node_modules/.bin/ndjson-map 'd.properties.class="residential",d' > local/ne_10m_urban_areas.geojson
